    ...
    for _ in tqdm(range(n_sample)):
        ...
        if not stochastic:
            ...
            if candidate_k:
                ...
                print(f"Warning: No valid candidates generated in iteration {_+1}, skipping...")
                # Either skip this iteration or add a placeholder
                candidate.append("C")  # Add methane as a placeholder
    return candidate
...
def main(args, config):
    ...
    output_file = "generated_molecules_from_pv.txt"
